...
for a in "${array1[@]}"; do
  ...
  echo "--------------------------------------------------" >> ./test_result/changedTable/ChangedTableResult.txt
      ...
      mysql -h10.105.24.81 -ucypress -pmooc123 -e "select * from $a" server81 >> ./test_result/changedTable/changedTable81/file81_$a.txt

      mysql -h10.105.24.84 -ucypress -pmooc123 -e "select * from $a" server84 >> ./test_result/changedTable/changedTable84/file84_$a.txt
...
for a in "${array1[@]}"; do
  ...
  echo "--------------------------------------------------" >> ./test_result/ModifiedTable/ModifiedTableResult.txt
   ...
   mysql -h10.105.24.81 -ucypress -pmooc123 -e "SELECT COLUMN_NAME FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = '$a' and TABLE_SCHEMA = 'server81' " server81 >> ./test_result/ModifiedTable/ModifiedTable81/file81_$a.txt

   mysql -h10.105.24.84 -ucypress -pmooc123 -e "SELECT COLUMN_NAME FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = '$a' and TABLE_SCHEMA = 'server84'" server84 >> ./test_result/ModifiedTable/ModifiedTable84/file84_$a.txt
   ...
   if diff  ./test_result/ModifiedTable/ModifiedTable84/file84_$a.txt ./test_result/ModifiedTable/ModifiedTable81/file81_$a.txt >> ./test_result/ModifiedTable/ModifiedTableResult.txt; then
	...
	grep '^[a-zA-ZFAILED]' ./test_result/ModifiedTable/ModifiedTableResult.txt >> ./report
...
mysql -h10.105.24.81 -ucypress -pmooc123 -e "SELECT  TABLE_NAME FROM information_schema.TABLES  WHERE TABLE_SCHEMA = 'server81' AND TABLE_NAME NOT IN (SELECT  TABLE_NAME FROM information_schema.TABLES WHERE TABLE_SCHEMA = 'server84')" >> ./test_result/newTable/newTableResult.txt 
mysql -h10.105.24.81 -ucypress -pmooc123 -e "SELECT  COUNT(*) FROM information_schema.TABLES  WHERE TABLE_SCHEMA = 'server81' AND TABLE_NAME NOT IN (SELECT  TABLE_NAME FROM information_schema.TABLES WHERE TABLE_SCHEMA = 'server84')" >> ./test_result/newTable/newTableCount.txt 
...
mysql -h10.105.24.81 -ucypress -pmooc123 -e "SELECT  TABLE_NAME FROM information_schema.TABLES  WHERE TABLE_SCHEMA = 'server81' AND TABLE_NAME IN (SELECT  TABLE_NAME FROM information_schema.TABLES WHERE TABLE_SCHEMA = 'server84')" >> ./test_result/sameTable/sameTableResult.txt 

mysql -h10.105.24.81 -ucypress -pmooc123 -e "SELECT  COUNT(*) FROM information_schema.TABLES  WHERE TABLE_SCHEMA = 'server81' AND TABLE_NAME IN (SELECT  TABLE_NAME FROM information_schema.TABLES WHERE TABLE_SCHEMA = 'server84')" >> ./test_result/sameTable/sameTableCount.txt 
