...
for a in "${array1[@]}"; do
  ...
  echo "--------------------------------------------------" >> ./test_result/changedTable/ChangedTableResult.txt
      ...
      mysql -h10.105.24.81 -ucypress -pmooc123 -e "select * from $a" edxapp8 >> ./test_result/changedTable/changedTable81/file81_$a.txt

      mysql -h10.105.24.84 -uaspen -pmooc123 -e "select * from $a" edxapp >> ./test_result/changedTable/changedTable84/file84_$a.txt
...
for a in "${array1[@]}"; do
  ...
  echo "--------------------------------------------------" >> ./test_result/ModifiedTable/ModifiedTableResult.txt
   ...
   mysql -h10.105.24.81 -ucypress -pmooc123 -e "SELECT COLUMN_NAME FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = '$a' and TABLE_SCHEMA = 'edxapp8' " edxapp8 >> ./test_result/ModifiedTable/ModifiedTable81/file81_$a.txt

   mysql -h10.105.24.84 -uaspen -pmooc123 -e "SELECT COLUMN_NAME FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = '$a' and TABLE_SCHEMA = 'edxapp'" edxapp >> ./test_result/ModifiedTable/ModifiedTable84/file84_$a.txt
...
mysql -h10.105.24.81 -ucypress -pmooc123 -e "SELECT  TABLE_NAME FROM information_schema.TABLES  WHERE TABLE_SCHEMA = 'edxapp8' AND TABLE_NAME NOT IN ($str)" >> ./test_result/newTable/newTableResult.txt 
mysql -h10.105.24.81 -ucypress -pmooc123 -e "SELECT  COUNT(*) FROM information_schema.TABLES  WHERE TABLE_SCHEMA = 'edxapp8' AND TABLE_NAME NOT IN ($str)" >> ./test_result/newTable/newTableCount.txt 
...
mysql -h10.105.24.81 -ucypress -pmooc123 -e "SELECT  TABLE_NAME FROM information_schema.TABLES  WHERE TABLE_SCHEMA = 'edxapp8' AND TABLE_NAME IN ($str)" >> ./test_result/sameTable/sameTableResult.txt 

mysql -h10.105.24.81 -ucypress -pmooc123 -e "SELECT  COUNT(*) FROM information_schema.TABLES  WHERE TABLE_SCHEMA = 'edxapp8' AND TABLE_NAME IN ($str)" >> ./test_result/sameTable/sameTableCount.txt 
